...
-o $CORE_PATH/$PROJECT/MIXED/FILTERED_ON_TARGET/$SM_TAG".MIXED.ON_TARGET.PASS.vcf.gz"

END_FILTER_TO_SAMPLE_TARGET_MIXED_PASS=`date '+%s'`

HOSTNAME=`hostname`

echo $PROJECT",S.001,FILTER_TO_SAMPLE_TARGET_MIXED_PASS,"$HOSTNAME","$START_FILTER_TO_SAMPLE_TARGET_MIXED_PASS","$END_FILTER_TO_SAMPLE_TARGET_MIXED_PASS \
...
md5sum $CORE_PATH/$PROJECT/MIXED/FILTERED_ON_TARGET/$SM_TAG".MIXED.ON_TARGET.PASS.vcf.gz" \
>> $CORE_PATH/$PROJECT/REPORTS/$PROJECT".CIDR.Analysis.MD5.txt"

md5sum $CORE_PATH/$PROJECT/MIXED/FILTERED_ON_TARGET/$SM_TAG".MIXED.ON_TARGET.PASS.vcf.gz.tbi" \
>> $CORE_PATH/$PROJECT/REPORTS/$PROJECT".CIDR.Analysis.MD5.txt"
