...
echo $PROJECT",U.01,VARIANT_TO_TABLE_BGZIP_"$SM_TAG"_ALL_SITES,"$HOSTNAME","$START_VARIANT_TO_TABLE_BGZIP_SAMPLE","$START_VARIANT_TO_TABLE_BGZIP_SAMPLE \
...
md5sum $CORE_PATH/$PROJECT/VCF/FILTERED_ON_BAIT/$SM_TAG".ALL_SITES.txt.gz" \
